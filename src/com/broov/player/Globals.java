...
class Globals {
    ...
    public static String supportedFileFormats[] = concat(
            ...
            supportedFontFileType);

    public static final String PREFS_NAME = "BroovPrefsFile"; // user preference
                                                              // file name
    ...
    public static String aboutUsContent = "<font color='white'>"
            + "<P ALIGN=CENTER><b>"
    ...
    public static String helpContent = "<font color='white'>"
            + "<P ALIGN=CENTER>  "
            + Globals.ApplicationName
            + " "
            + Globals.VersionName
            + " is an audio and video player for Android 2.1 and above."
            + "</p>"
            + "<P ALIGN=CENTER>"
            + "<b>Play Media</b>"
            + "</p>"
    ...
    public static boolean dbadvancedffmpeg = false; // fast decoding is disabled
                                                    // by default
    public static int dbadvancedyuv = Globals.ARM_ASM; // sws_scaler - 1, arm
                                                       // asm - 0
     ...
     * 
     * @param choice
     *            true if user is viewing hidden files, false otherwise
     */
...
/*
 * <!-- The application's publisher ID assigned by AdMob --> <meta-data
 * android:value="a14d675ebf005c0" android:name="ADMOB_PUBLISHER_ID" /> <!--
 * AdMobActivity definition --> <activity
 * android:name="com.admob.android.ads.AdMobActivity"
 * android:theme="@android:style/Theme.NoTitleBar.Fullscreen"
 * android:configChanges="orientation|keyboard|keyboardHidden" /> <!-- Track
 * Market installs --> <receiver
 * android:name="com.admob.android.ads.analytics.InstallReceiver"
 * android:exported="true"> <intent-filter> <action
 * android:name="com.android.vending.INSTALL_REFERRER" /> </intent-filter>
 * </receiver> <meta-data android:value="true"
 * android:name="ADMOB_ALLOW_LOCATION_FOR_ADS" /> <!-- use a separate publisher
 * id here to aid in tracking intersitial statistics --> <meta-data
 * android:value="a14d675ebf005c0"
 ...
 * app:secondaryTextColor="#CCCCCC" /> res/main.xml, AVPlayerMain.java,
 * AndroidManifest.xml for ADMob
 */

/*
 * "<b> Skip Frames</b>" + "<P ALIGN=JUSTIFY>" +
